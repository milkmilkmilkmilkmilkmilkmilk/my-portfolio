    ...
    return {
      ...
      answers: {
        1: {
          ...
          content: "<p>Чуваааааак, я решил делать лендинги на заказ под макет.Но, черт возьми, такая хрень: не могу найти клиентов для старта, представляешь?! Вообщем, ни знакомы, ни на одном сайте по фрилансу не требуются мои услуги, даже за гроши. А все, мать его, почему? А? Да потому что нет крутого портфолио, все про портфолио только и балаболят, мне осточертело это сранное портфолио, вот я и решил сделать сайт с рекламой меня. Поэтому, сукин сын, бери контакты и предлагай мне работу!</p>"
        },
        2: {
